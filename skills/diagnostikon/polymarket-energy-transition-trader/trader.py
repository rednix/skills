...
Trades energy transition markets: EV adoption, solar/wind capacity, nuclear restarts, oil prices, and energy policy milestones.
...
KEYWORDS = ['electric vehicle', 'EV', 'Tesla', 'BYD', 'charging station', 'solar', 'wind energy', 'renewable', 'nuclear', 'uranium', 'oil price', 'Brent crude', 'OPEC', 'energy transition', 'battery', 'grid', 'power plant', 'carbon', 'net zero', 'IEA', 'offshore wind', 'hydrogen', 'natural gas', 'LNG', 'pipeline', 'energy storage']
